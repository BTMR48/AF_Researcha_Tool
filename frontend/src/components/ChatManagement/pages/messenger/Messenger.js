...
export default function Messenger() {
  ...
  useEffect(() => {
    const getConversations = async () => {
      try {
        const res = await axios.get("https://af-research-tool.herokuapp.com/api/conversations/" + user._id);
  ...
  useEffect(() => {
    const getMessages = async () => {
      try {
        const res = await axios.get("https://af-research-tool.herokuapp.com/api/messages/" + currentChat?._id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://af-research-tool.herokuapp.com/api/messages", message);
  ...
  function handleSearch(event) {
    ...
    axios.get("https://af-research-tool.herokuapp.com/api/conversations/" + user._id).then((res) => {
